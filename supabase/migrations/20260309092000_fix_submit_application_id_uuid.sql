drop function if exists public.submit_application_with_slot(
  text, text, text, text, text, text, text, text, text, text, text, text, text
);

create function public.submit_application_with_slot(
  p_full_name text,
  p_email text,
  p_phone text,
...
returns table(application_id uuid, slots_left integer)
language plpgsql
security definer
